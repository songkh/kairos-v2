 ...
 */
export function validateGpsTrack(points: GpsPoint[]): GpsPoint[] {
 ...
 */
export function calculateAvgPace(points: GpsPoint[], durationSec: number): number {
